    ...
    <body class="bg-gray-50 flex flex-col ">
        ...
        <main class="flex-grow py-12 md:py-16 lg:py-20 bg-gray-50 text-gray-900 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <section class="text-center">
                <h1 class="text-4xl font-bold text-red-700 mb-4">⏰ Reservation Expired</h1>
                <p class="text-lg text-gray-700 mb-6">Unfortunately, your seat reservation has expired. Please select your seats again to proceed with booking.</p>
