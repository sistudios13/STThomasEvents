    ...
    <div>
        <form hx-post=" <?= url('/tickets/authenticate/') ?>">
            ...
            <div class="space-y-8">
                ...
                <div class="border-b border-gray-300 pb-0 focus-within:border-green-600 transition">
                    <label x-data="{tool : false}" aria-describedby="tooltip" for="code" class="relative text-xs font-semibold text-gray-500  pb-2 tracking-wide"><span class="uppercase">Tickets Access Code</span>
