...
<!-- HEADER -->
<header class="flex-shrink-0 bg-white border-b border-gray-100 pb-4 z-10">
    <div class="max-w-7xl mx-auto md:text-center">
        <h2 class="text-lg font-medium tracking-tight text-gray-800">Seatmap</h2>
    </div>
</header>
...
<div x-data="app()" class="flex flex-col">
    ...
    <!-- PAN/ZOOM VIEWPORT -->
    <div class="flex-1 relative bg-slate-100 min-h-80 sm:min-h-96 rounded-md md:min-h-[24rem] lg:min-h-[28rem]">
